...
export const Menubar = <T extends ValidComponent = "div">(
  ...
  return (
    <MenubarPrimitive
      class={cn("flex h-9 items-center space-x-1 p-1 shadow-sm", local.class)}
      {...rest}
    />
  );
};
...
export const MenubarTrigger = <T extends ValidComponent = "button">(
  ...
  return (
    <MenubarPrimitive.Trigger
      class={cn(
        "flex cursor-default select-none items-center px-3 py-1 text-sm font-medium data-[expanded]:text-accent-foreground",
        local.class
      )}
      {...rest}
    />
